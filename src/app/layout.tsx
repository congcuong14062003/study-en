...
export const metadata: Metadata = {
  ...
  title: {
    default: "EnglishMaster — Chinh phục tiếng Anh mỗi ngày",
    template: "%s | EnglishMaster",
  },
  description:
    "Học tiếng Anh theo lộ trình của bạn. Từ vựng, ngữ pháp, nghe, nói, đọc, viết và AI Tutor dành cho người Việt.",
  openGraph: {
    title: "EnglishMaster",
    description: "Chinh phục tiếng Anh mỗi ngày",
    locale: "vi_VN",
    type: "website",
  },
};
