...
export function LoadingSkeleton() {
  return (
    <div aria-label="Đang tải nội dung" role="status">
      <Skeleton className="mb-4" style={{ width: 220, height: 30 }} />
...
export function EmptyState({
  ...
  description = "Bắt đầu khám phá và tạo nên hành trình của bạn.",
  href = "/courses",
