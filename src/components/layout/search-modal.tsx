...
export function SearchModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogTitle>Tìm điều bạn muốn học</DialogTitle>
        <DialogDescription>
          Khóa học, từ vựng, ngữ pháp hoặc bài đọc.
        </DialogDescription>
        ...
        <div className="search-results">
          {loading ? (
            <div className="flex-row muted">
              <Loader2 size={16} className="spin" /> Đang tìm kiếm…
            </div>
          ) : error ? (
            ...
            <p>Thử “daily”, “travel” hoặc “present”.</p>
          )}
        </div>
      </DialogContent>
    </Dialog>
